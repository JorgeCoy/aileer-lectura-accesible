...
const RoleSelection = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 font-sans text-text-main">
            <div className="max-w-4xl w-full text-center space-y-12">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto w-full">
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-surface hover:bg-primary/10 border-2 border-border-color hover:border-primary rounded-3xl p-8 transition-all duration-300 shadow-lg hover:shadow-xl text-left flex flex-col h-64 justify-between"
                    >
                        ...
                        <div className="z-10">
                            ...
                            <h2 className="text-3xl font-bold text-text-main group-hover:text-primary transition-colors">
                                Soy Docente
                            </h2>
                        </div>

                        <div className="z-10 text-text-muted group-hover:text-text-main">
